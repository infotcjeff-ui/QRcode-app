      ...
      <div className="grid gap-4 lg:grid-cols-[320px_1fr]">
        <Card className="h-fit">
          <CardHeader className="pb-3">
            ...
            <CardDescription>點擊查看詳細內容</CardDescription>
          </CardHeader>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {isActive ? (
                        <Badge variant="success" className="text-[10px]">查看中</Badge>
                      ) : null}
                    </div>
                  </button>
                );
        ...
        <div className="flex flex-col gap-4">
          {selected ? (
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">尚未選擇報表</CardTitle>
                <CardDescription>
                  從左側選擇一份報表，或使用上方表單生成新的進階統計表。
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-md border border-dashed border-slate-200 bg-slate-50 p-10 text-center text-sm text-slate-400">
